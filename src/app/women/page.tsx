...
export default async function WomenCollectionPage() {
  ...
  try {
    products = await getDbProductsByCategory("Women");
  } catch (err: any) {
      ...
      <section className="relative h-[40vh] min-h-[250px] w-full bg-zinc-950 flex flex-col justify-end p-8 md:p-16 border-b border-white/10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="text-zinc-400 text-sm mt-3 max-w-lg leading-relaxed">
            Curated minimalist silhouettes. Luxury materials tailored to provide fluid comfort, boxy streetwear looks, and refined casual structure.
          </p>
        </div>
      </section>
